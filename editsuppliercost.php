...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$MeasurementID = $_REQUEST["m"];
	$BillingType = $_REQUEST["b"];
	
	$CurrentBillingDetails = GetCurrentSupplierBillingDetails($ProductID, $SupplierID, $MeasurementID, $BillingType);
	
	while ($Val = mysqli_fetch_array($CurrentBillingDetails))
	{
		$SupplierCost = $Val["SupplierCost"];
		$ProRataBilling = $Val["ProRataBilling"];	
	}
	
	$GetSellingPrice = GetCurrentSellingPrice($ProductID, $SupplierID, $MeasurementID, $BillingType);
	$SellingPrice = 0;
	
	while ($Selling = mysqli_fetch_array($GetSellingPrice))
	{
			$SellingPrice = $Selling["ClientCost"];
	}
...
<tr><td>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                               <strong><i class="fa fa-upload fa-fw"></i> Edit Supplier Pricing</strong>
                                          </div>
                                            <!-- /.panel-heading -->
                                            <div class="panel-body"><!-- /.table-responsive -->
                                                ...
                                                <div class="form-group row col-md-12">
                                                 ...
                                                 <div class="form-group row col-md-12">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="packsize" disabled="disabled">
                                                 ...
                                                 <div class="form-group row col-md-12">
                                                  ...
                                                  <div class="col-sm-12">
                                                  <select name="billingtype" class="form-control" id="billingtype" disabled="disabled">
