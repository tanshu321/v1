...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	CreateClientAccess($CustomerID, 'Accessed Customer Sites');
	...
	if ($FoundClient != 0)
	{
		...
		$CustomerSites = GetCustomerSites($CustomerID);
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to manage all the additional sites for this customer account. To add a new site simply click on the Add Site button below.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                             ...
                             <h4>Customer Sites <a href="addsite.php?c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add Site</a></h4>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                ...
                                <tbody>
                                	<?php while ($Val = mysqli_fetch_array($CustomerSites)) 
									{ 
										$SiteID = $Val["SiteID"];
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="editsite.php?c=<?php echo $CustomerID ?>&s=<?php echo $SiteID ?>" class="btn btn-sm btn-default">Edit Site</a></td>
