...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	if ($FoundClient != 0)
	{
		...
		$ContactID = $_REQUEST["con"];
		
		$SingleContact = GetSingleContact($ContactID);
		
		while ($Val = mysqli_fetch_array($SingleContact))
		{
			$ContactName = $Val["Name"];
			$ContactSurname = $Val["Surname"];
			$ContactCompanyName = $Val["CompanyName"];
			$EmailAddress = $Val["EmailAddress"];
			$ContactNumber = $Val["ContactNumber"];
			$EmailInvoice = $Val["EmailInvoice"];
			$EmailSupport = $Val["EmailSupport"];
			$AddContacts = $Val["AddContacts"];
			$AddProducts = $Val["AddProducts"];
			$AcceptQuotes = $Val["AcceptQuotes"];
			$ChangeDetails = $Val["ChangeDetails"];
			$EmailQuotes = $Val["EmailQuotes"];
		}
...
function DeleteContact()
{
	...
	{ 
		if (result === true)
		{
			var DelCon = agent.call('','DeleteContact', '', '<?php echo $ContactID ?>');	
			
			if (DelCon == "OK")
			{
				bootbox.alert("Contact removed successfully", function(){ document.location = 'clientcontacts.php?c=<?php echo $CustomerID ?>'; });	
			}
		}
	});
}
...
function UpdateContact()
{
	...
	{
		var UpdateContact = agent.call('','UpdateContact','', Name, Surname, CompanyName, ContactTel, EmailAddress, Department, EmailSupport, EmailQuotes, EmailInvoices, AddContacts, AcceptQuotes, ChangeDetails, '<?php echo $ContactID ?>');
		if (UpdateContact == "OK")
		{
			//LOG EVENT
			var Log = agent.call('','CreateClientAccess', '', <?php echo $CustomerID ?>, 'Contact Updated ' + Name + " " + Surname);
			bootbox.alert("Contact updated successfully", function(){ document.location = 'clientcontacts.php?c=<?php echo $CustomerID ?>'; });
		}
		else
		{
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to edit or remove the customer contact information
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                             ...
                             <div class="col-lg-12" style="padding-top: 10px">
                                        <h4 style="padding-bottom: 10px">Contact Details</h4>
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="firstname" placeholder="First Name" value="<?php echo $ContactName ?>">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="surname" placeholder="Surname" value="<?php echo $ContactSurname ?>">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="department" placeholder="Department" value="<?php echo $Department ?>">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12" align="center" style="padding-top: 20px; padding-bottom: 20px">
                                                	<button class="btn btn-info" onClick="javascript: UpdateContact();" style="margin-right: 20px">Update Contact</button> 
                                                
                                                    <button class="btn btn-danger" onClick="javascript: DeleteContact();">Remove Contact</button> 
                                            </div>
