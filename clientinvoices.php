...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	CreateClientAccess($CustomerID, 'Accessed Customer Invoices');
	...
	if ($FoundClient != 0)
	{
		...
		$ClientInvoices = GetAllCustomerInvoices($CustomerID);
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to view all the customer generated invoices.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                             ...
                             <h4>Customer Invoices <a href="addcustomerinvoice.php?c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add Invoice</a></h4>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        <?php while ($Val = mysqli_fetch_array($ClientInvoices))
                                                        {
															...
															{
																$Button = 	'<a href="editcustomerinvoice.php?i=' . $InvoiceID . '&c=' . $CustomerID .'" class="btn btn-sm btn-default">Edit Invoice</a>';
															}
															else
															{
																$Button = 	'<a href="showcustomerinvoice.php?i=' . $InvoiceID . '&c=' . $CustomerID .'" class="btn btn-sm btn-default">Show Invoice</a>';
															}
