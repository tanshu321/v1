...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	CreateClientAccess($CustomerID, 'Accessed Customer Documents');
		...
		if ($_SESSION["MainClient"] == 1)
	{
		...
		{
			$Access = CheckPageAccess('Documents');	
		}
                ...
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                        ...
                        <?php if ($Access == 1) { ?>  
                             ...
                             <h4>Customer Documents <a href="adddocument.php?c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add Document</a></h4>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        <?php while ($Val = mysqli_fetch_array($ClientDocuments))
                                                        {
															...
															$GroupName = GetDocumentGroupName($DocumentGroupID);
                                                        ...
                                                        <tr class="odd gradeX">
                                                           <td><?php echo $GroupName ?></td>
                                                            ...
                                                            <td><a href="downloaddocument.php?d=<?php echo $DocumentID ?>&c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default">Download</a></td>
