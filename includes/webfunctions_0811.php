...
function GetCustomerProjects($CustomerID)
{
    ...
    $cretaeInvoiceTableQry = "CREATE TABLE `customerprojectinovice` ( `ProjectInvoiceId` INT NOT NULL AUTO_INCREMENT , `ProjectId` INT NOT NULL , `InvoiceId` INT NOT NULL , PRIMARY KEY (`ProjectInvoiceId`)) ENGINE = InnoDB;";
