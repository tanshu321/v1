...
function SendCustomerInvoice($CustomerID, $InvoiceID)
{
    ...
    $data[] = array('<b>Customer Details</b>'=>'<b>' . $CompanyName . '</b>','<b>Address</b>'=> $CustomerAddress1, '<b>TAX Invoice</b>'=>'<b>Invoice Number : ' .$InvoiceNumber."</b>");
...
if($TaxExempt == 0) {
    ...
    if(!empty($additionalnotes)) {
        $pdf->ezSetDy(-20);
        $pdf->addText(20,230,10,"Additional Invoice Notes");
        $pdf->addText(20,220,9,$additionalnotes);
