...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$CustomDetails = GetCustomerCustomField($ThisCustomID);
...
function EditCustomOption(CustomFieldOptionID, CurrentValue)
{
	bootbox.prompt({
	  ...
	  callback: function(result) 
	  {
		...
		{
			var UpdateProductOption = agent.call('','UpdateCustomerCustomOption','', NewOption, CustomFieldOptionID);
...
function RemoveOption(CustomFieldOptionID)
{
	...
	{ 
		if (result == true)
		{
			var DoRemoveOption = agent.call('','RemoveCustomCustomerOption','', CustomFieldOptionID);	
...
function UpdateMainCustom()
{
	...
	{
		var DoUpdate = agent.call('','UpdateCustomCustomerField','', FieldName, Required, DisplayOrder, '<?php echo $ThisCustomID ?>', DisplayInvoice, DisplayQuote);
		if (DoUpdate == "OK")
		{
...
function AddCustomOption()
{
	bootbox.prompt({
	  ...
	  callback: function(result) 
	  {
		...
		if (NewOption != "" && NewOption != null)
		{
			var AddProductOption = agent.call('','AddCustomCustomerOption','', NewOption, '<?php echo $ThisCustomID ?>');
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Customer Custom Fields<img src="images/logo.png" class="img-responsive pull-right" style="height: 45px"></h1>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <ul class="nav nav-tabs" style="margin-bottom: 20px">
                                ...
                                <li class="pull-right"><a href="customsetup.php"><i class="fa fa-caret-left"></i> Back to All Custom Fields</a>
                                </li>
                         ...
                         <?php if ($Access == 1) { ?>
                            ...
                            <div class="form-group row col-md-6">
                              <label for="tel" class="col-sm-5 col-form-label" style="padding-top: 5px">Display on Invoice *</label>
                              <div class="col-sm-6">
                            ...
                            <div class="form-group row col-md-6">
                              <label for="tel" class="col-sm-5 col-form-label" style="padding-top: 5px">Display on Quotes *</label>
                              <div class="col-sm-6">
						  ...
						  { 
						  		$CustomFieldOptions = GetCustomFieldOptionsCustomer($ThisCustomID);
