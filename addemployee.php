...
function UpdateEmployee()
{
	...
	if (SystemAccess == 1)
	{
		var CheckSpots = agent.call('','MaxSystemUsers','');	
	...
	if (Error == 0)
	{
		if (SystemAccess == 1)
		{
			...
			{
				bootbox.alert("Please enter a username and password for this employee");
				Error = 1;
			}
			else
			{
	...
	if (Error == 0)
	{
		...
		{
			var UpdateEmployee = agent.call('', 'AddEmployeeDetails','', Name, Surname, IDNumber, EmployeeNumber, TaxReference, Department, Extension, ContactHome, ContactCell, ContactEmail, AlternativeContact, AlternativeTel, Address1, Address2, City, State, PostCode, Country,  SystemAccess, EmployeeStatus, UserName, Password, SecurityGroup);
                ...
                <div class="col-lg-12">
                  <div class="alert alert-info">
                            ...
                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group col-md-6">
                                                  <label for="postcode" class="col-sm-5 col-form-label" style="padding-top: 5px">Password</label>
                                                  <div class="col-sm-6">
                                                ...
                                                <div class="box-footer" align="center" style="margin-bottom: 50px; margin-top: 20px">
                                                    ...
                                                    <button type="button" class="btn btn-primary pull-right" onClick="javascript: UpdateEmployee();">Add Details</button>
                                                 </div>
                            </div>
                            <!-- /.table-responsive -->
