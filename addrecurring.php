...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$NumRecurring = mysqli_num_rows($Recurring);
	
	$NextRecurring = $NumRecurring + 1;
	if ($NextRecurring < 10)
	{
		$RecurringReference = "RINV" . $NextInvoice;
	}
	else if ($NextRecurring < 100)
	{
		$RecurringReference = "RINV" . $NextInvoice;
	}
	else if ($NextRecurring < 1000)
	{
		$RecurringReference = "RINV" . $NextInvoice;
	}
	else if ($NextRecurring < 10000)
	{
		$RecurringReference = "RINV" . $NextInvoice;
	}
	else if ($NextRecurring < 100000)
	{
		$RecurringReference = "RINV" . $NextInvoice;
	}
...
function ShowTotal()
{
	...
	var ThisClient = document.getElementById("customer").value;
	var ChargeVat = 0;
...
function CreateRecurring()
{
	...
	var RecurringInvoiceNumber = document.getElementById("reccuringnumber").value;
	var DiscountPercent = document.getElementById("discount").value;
	
	//INVOICE SETUP
	var StartDate = document.getElementById("startdate").value;
	var EndDate = document.getElementById("enddate").value;
	var DaysTillDue = document.getElementById("duedays").value;
	var Frequency = document.getElementById("frequency").value;
	var Status = document.getElementById("status").value;
	var AdminInvoiceNotes = document.getElementById("invoicenotes").value;
	
	//CHECK IF REQUIRED FIELDS ARE FILLED IN
	if (Customer != "" && StartDate != "" && DaysTillDue != "" && Frequency != "")
	{
		...
		{
			//CREATE BASE INVOICE
			var CreateRecurring = agent.call('','CreateRecurringInvoice','', Customer, Reference, RecurringInvoiceNumber, DiscountPercent, StartDate, EndDate, DaysTillDue, Frequency, Status, AdminInvoiceNotes);
			if (CreateRecurring > 0)
			{
				...
				for (var X = 1; X <= RowCounter; X++)
				{
					if ($('#total' + X).length > 0) 
					{
						...
						var AddRecurringLine = agent.call('','AddRecurringLine','', CreateRecurring, Item, Description, Quantity, Price);
	
					}
				}
				
				bootbox.alert('Recurring Invoice added successfully', function() {
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Recurring Invoice  <img src="images/logo.png" class="img-responsive pull-right" style="height: 45px"></h1>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group row col-md-6">
                              <label for="firstname" class="col-sm-5 col-form-label" style="padding-top: 5px">Customer *</label>
                              <div class="col-sm-6">
                                <select class="form-control" id="customer" onChange="javascript: ShowTotal();">
									...
									?>
                                    <option value="<?php echo $CustomerID ?>" <?php echo $Selected ?>><?php echo $Name . " " . $Surname , " (" . $CompanyName . ")" ?></option>
                                    <?php } ?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              <label for="reccuringnumber" class="col-sm-5 col-form-label" style="padding-top: 5px">Recurring Invoice Number *</label>
                              <div class="col-sm-6">
                                <input type="text" class="form-control" id="reccuringnumber" placeholder="Recurring Invoice Number" value="<?php echo $RecurringReference ?>" disabled>
                              </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong><i class="fa fa-table fa-fw"></i> Recurring Invoice Setup</strong>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row col-md-6">
                              <label for="enddate" class="col-sm-5 col-form-label">End Date (optional)</label>
                              <div class="col-sm-6">
                            ...
                            <div class="form-group row col-md-6">
                              <label for="firstname" class="col-sm-5 col-form-label">Days till Due Date *</label>
                              <div class="col-sm-6">
                                 <select class="form-control" id="duedays">
                            ...
                            <div class="form-group row col-md-6">
                              <label for="frequency" class="col-sm-5 col-form-label" style="padding-top: 5px">Frequency *</label>
                              <div class="col-sm-6">
                                <select id="frequency" class="form-control">
                                        ...
                                        <option value="Every Nine Months">Every Nine Months</option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12" style="padding-top: 20px; padding-bottom: 20px">
                                                <button class="btn btn-info pull-right" onClick="javascript: CreateRecurring();">Create Recurring Invoice</button>
