...
function UpdateProductCosting()
{
	...
	{
		var UpdateCost = agent.call('','AddSupplierCosting','', 	BillingType, SellPrice, PackSize, Meassure, StockAffect, ProRata, "<?php echo $ProductID ?>", MinOrder, "<?php echo $SupplierID ?>");
		if (UpdateCost == "OK")
		{
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to add your supplier product costing.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
