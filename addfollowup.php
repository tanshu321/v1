...
function AddFollowUp()
{
	...
	{
		var AddFollow = agent.call('','AddNewFollowUp','', Description, FollowUpDate, '<?php echo $CustomerID ?>');
		if (AddFollow == "OK")
		{
			//LOG EVENT
			var Log = agent.call('','CreateClientAccess', '', <?php echo $CustomerID ?>, 'Added Customer Follow Up');
					
			bootbox.alert('Follow Up added successfully', function() {
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to add a new follow up
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                             ...
                             <div class="col-lg-12" style="padding-top: 10px">
                                        <h4 style="padding-bottom: 10px">Follow Up Details</h4>
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <textarea class="form-control" placeholder="Description" id="task"></textarea>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control datepicker" id="datepicker" name="datepicker" placeholder="Follow Up Date" value="" data-date-format="yyyy-mm-dd">
                                                ...
                                                <!-- END FORM CONTROLS -->
                                                 <div class="form-group row col-md-12" align="center" style="padding-top: 50px">
                                                	<button class="btn btn-info" onClick="javascript: AddFollowUp();" style="">Add Follow Up</button> 
