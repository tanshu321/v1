    ...
    <script type="text/javascript">
        function AddPeriod() {
            ...
            if (title != "" && month != "0" && description != "" && contact_account != "" && gdc!='0') {
                var DoAdd = agent.call('', 'AddPeriod', '', title, month, description, contact_account,gdc);
                if (DoAdd == "OK") {
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12 tab-content">
                    ...
                    <div class="form-group row col-md-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id='gdc' class="form-control" >
                                ...
                                <?php
                                for($i=0;$i<count($gdc);$i++){

                                    ?>
                                    <option value='<?php echo $gdc[$i];?>'><?php echo $gdc[$i];?></option>
                                    <?php
                    ...
                    <div class="form-group row col-md-12" align="center" style="padding-top: 40px">
                        <button class="btn btn-default" onClick="javascript: AddPeriod();">Add Period</button>
