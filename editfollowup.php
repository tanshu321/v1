...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	if ($FoundClient != 0)
	{
		...
		$FollowUpID = $_REQUEST["f"];
		$FollowUpDetails = GetFollowUp($FollowUpID);
		
		while ($Val = mysqli_fetch_array($FollowUpDetails))
		{
			$Description = $Val["Description"];
			$FollowUpDate = $Val["FollowUpDate"];
			$FollowUpStatus = $Val["Status"];
			$Outcome = $Val["Outcome"];
		}
		...
		if ($_SESSION["MainClient"] == 1)
	{
		...
		{
			$Access = CheckPageAccess('Follow Ups');	
		}
...
function UpdateFollowUp()
{
	...
	var FollowUpDate = document.getElementById("datepicker").value;
	var Status = document.getElementById("taskstatus").value;
	var Outcome = document.getElementById("outcome").value;
	
	if (Description != '' && FollowUpDate != '')
	{
		if (Status == 1 && Outcome != "")
		{
			var AddFollow = agent.call('','UpdateFollowUp','', Description, FollowUpDate, Status, Outcome, '<?php echo $FollowUpID ?>', '<?php echo $CustomerID ?>');
			if (AddFollow == "OK")
			{
				//LOG EVENT
				var Log = agent.call('','CreateClientAccess', '', <?php echo $CustomerID ?>, 'Updated Customer Follow Up');
						
				bootbox.alert('Follow Up updated successfully', function() {
							document.location = 'clientfollowup.php?c=<?php echo $CustomerID ?>';
				});
				
			}
			else
			{
				bootbox.alert(AddFollow);	
			}
		}
		else
		{
			bootbox.alert("Please add an outcome to this follow up");	
		}
	}
	else
	{
                ...
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                                ...
                                <li  class="active"><a href="clientfollowup.php?c=<?php echo $CustomerID ?>">Follow Ups</a>
                                </li>
                         ...
                         <?php if ($Access == 1) { ?>               
                             ...
                             <div class="col-lg-12" style="padding-top: 10px">
                                        <h4 style="padding-bottom: 10px">Follow Up Details</h4>
                                                <div class="form-group row col-md-6">
                                                  <label for="documentname" class="col-sm-5 col-form-label" style="padding-top: 5px">Description *</label>
                                                  <div class="col-sm-6">
                                                    <textarea class="form-control" placeholder="Description" id="task"><?php echo $Description ?></textarea>
                                                  </div>
                                                </div>
                                                
                                                
                                                <div class="form-group row col-md-6">
                                                  <label for="documentname" class="col-sm-5 col-form-label" style="padding-top: 5px">Outcome *</label>
                                                  <div class="col-sm-6">
                                                    <textarea class="form-control" placeholder="Outcome" id="outcome"><?php echo $Outcome ?></textarea>
                                                  </div>
                                                </div>
                                                
                                                <div class="form-group row col-md-6">
                                                  <label for="documentgroup" class="col-sm-5 col-form-label" style="padding-top: 5px">Follow Up Date *</label>
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control datepicker" id="datepicker" name="datepicker" placeholder="Follow Up Date" value="<?php echo $FollowUpDate ?>">
                                                    
                                                  </div>
                                                </div>
                                                
                                                <div class="form-group row col-md-6">
                                                  <label for="documentgroup" class="col-sm-5 col-form-label" style="padding-top: 5px">Follow Up Status *</label>
                                                  <div class="col-sm-6">
                                                    <select id="taskstatus" class="form-control">
                                                    	<?php if ($FollowUpStatus == 0) { ?>
                                                ...
                                                <!-- END FORM CONTROLS -->
                                                 <div class="form-group row col-md-12" align="center" style="padding-top: 50px">
                                                	<button class="btn btn-info" onClick="javascript: UpdateFollowUp();" style="">Update Follow Up</button> 
