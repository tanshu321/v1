...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$StockOut = GetAllStockOutAll($ProductID);
	$StockIn = GetAllStockInAll($ProductID);
	$StockTake = GetAllStockTakeAll($ProductID);
	$StockTransfer = GetAllStockTransferAll($ProductID);
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
               ...
               <ul class="nav nav-tabs" style="margin-bottom: 20px">
                                ...
                                <li class="active"><a href="productstock.php?p=<?php echo $ProductID ?>"><i class="fa fa-caret-right"></i> Stock</a>
                                </li>
