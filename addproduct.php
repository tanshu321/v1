...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Product <img src="images/logo.png" class="img-responsive pull-right" style="height: 45px"></h1>
                </div>
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to add your products. Please make sure you have completed the setup of your product groups, sub groups, units of meassure as well as any custom fields you require for your business.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <ul class="nav nav-tabs" style="margin-bottom: 20px">
                             ...
                             <h4>Product Base Information</h4>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <textarea class="form-control" id="productdescription" placeholder="Product Description" value=""></textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control" id="productcode" placeholder="Product Code" value="">
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control" id="serialnumber" placeholder="Serial Number" value="">
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <select class="form-control" id="productgroup" onChange="javascript: GetSubGroups();">
									...
									?>
                                    <option value="<?php echo $ProductGroupID ?>"><?php echo $GroupName ?></option>
                                    <?php } ?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <select class="form-control" id="productsubgroup" disabled>
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <input type="number" class="form-control" placeholder="Mimimum Stock" value="0" disabled id="minstock">
                              </div>
                            </div>
                            ...
                            <div class="form-group row col-md-6">
                              <label for="productgroup" class="col-sm-5 col-form-label" style="padding-top: 5px"></label>
                              <div class="col-sm-6" >
                                <button class="btn btn-default pull-right" onClick="javascript: AddProduct();">Next >></button>
                              </div>
                            </div>
		...
		if (Name != "" && Description != "" && Code != "" && Group != "" && Warranty != "" && StockItem != "" && parseInt(MinStock) >= 0 && Catalogue != "" && Status != "")
		{
			...
			if (CustomIDs != "")
			{
				...
				if (CustomError == 0)
				{
					...
					var AddProductBase = agent.call('','AddBaseProduct','', Name, Description, Code, SerialNumber, Group, SubGroup, Warranty, StockItem, MinStock, Catalogue, Status);
					if (AddProductBase > 0)
					{
						//CUSTOM FIELDS
						var CustomIDArray = CustomIDs.split(":::");
						for (i = 0; i < CustomIDArray.length; i++) 
						{
							...
							{
								var HasData = document.getElementById("custom" + ThisCustomID).value;
								var SaveCustomEntry = agent.call('','SaveProductCustomEntry','', ThisCustomID, 0, HasData, AddProductBase);
							}
							...
							if ((ThisType == "checkbox" || ThisType == "radio"))
							{
								...
								for (z = 0; z < TheseOptions.length; z++) 
								{
									...
									var IsChecked = document.getElementById("customoption" + ThisOptionID).checked;
									var SaveCustomEntry = agent.call('','SaveProductCustomEntry','', ThisCustomID, ThisOptionID, IsChecked, AddProductBase);
								}
								
							}
						}
						
						document.location = 'editproductpricing.php?p=' + AddProductBase;
