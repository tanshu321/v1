...
function UpdateProductCosting()
{
	...
	{
		var UpdateCost = agent.call('','AddCosting','', 	BillingType, SellPrice, PackSize, Meassure, StockAffect, ProRata, "<?php echo $ProductID ?>", MinOrder);
		if (UpdateCost == "OK")
		{
			document.location = 'editproductpricing.php?p=<?php echo $ProductID ?>';
		}
		else
		{
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Costing <img src="images/logo.png" class="img-responsive pull-right" style="height: 45px"></h1>
                </div>
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to add your product costing.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <ul class="nav nav-tabs" style="margin-bottom: 20px">
                            ...
                            <div class="form-group row col-md-6">
                              <label for="productgroup" class="col-sm-5 col-form-label" style="padding-top: 5px"></label>
                              <div class="col-sm-6" >
                                <button class="btn btn-default pull-right" onClick="javascript: UpdateProductCosting();">Add Information</button>
                              </div>
                            </div>
