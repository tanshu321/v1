...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	{
		$Access = CheckPageAccess('Incomplete Jobcards');	
	}
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">My Job Cards <img src="images/logo.png" class="img-responsive pull-right" style="height: 45px"></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 20px">
                                <li class="active"><a href="jobcards.php"><i class="fa fa-caret-right"></i> Incomplete Job Cards</a>
                                </li>
                   ...
                   <div class="col-lg-12"> 
                             ...
                             <h4>Job cards <a href="addjobcard.php" class="btn btn-default pull-right" style="margin-bottom: 10px" ><i class="fa fa-plus"></i> Add Job card</a></h4>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example"  style="font-size: 12px">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="editjobcard.php?j=<?php echo $JobCardID ?>" class="btn btn-sm btn-default">View Job Card</a><?php if ($_SESSION["MainClient"] == 1) { ?>&nbsp;&nbsp;<a href="javascript: DeleteJobcard(<?php echo $JobCardID ?>)" class="btn btn-sm btn-danger">Delete Job Card</a><?php } ?></td>
