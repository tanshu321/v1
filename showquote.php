...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	if ($FoundCustom > 0)
	{
        ...
        if($TaxExempt == 0) {
            ...
            $pdf->ezTable($data, '', '', array('shaded' => 0, 'fontSize' => 7, 'xPos' => 580, 'xOrientation' => 'left', 'width' => 550, 'showLines' => 0, 'showHeadings' => 0, 'cols' => array(
                '<b>Custom 123</b>' => array('width' => 250)
            , '<b>Custom 1222</b>' => array('width' => 250), '<b>Rate</b>' => array('justification' => 'right'), '<b>Amount</b>' => array('justification' => 'right'))));
		}
	...
	if ($ProposalText != "")
	{
		...
		if($TaxExempt == 0) {
            ...
            , '<b>Product</b>' => array('width' => 250), '<b>Rate</b>' => array('justification' => 'right'),
                '<b>VAT Amt</b>' => array('justification' => 'right'), '<b>Amount</b>' => array('justification' => 'right'))));
        }else{
            $pdf->ezTable($data, '', '', array('shaded' => 1, 'fontSize' => 8, 'showLines' => 0, 'showHeading' => 0, 'xPos' => 580, 'xOrientation' => 'left', 'width' => 550, 'cols' => array(
                '<b>QTY</b>' => array('width' => 40)
            , '<b>Product</b>' => array('width' => 250), '<b>Rate</b>' => array('justification' => 'right'),
	...
	if ($NumOnceOff > 0)
	{
		...
		while ($CustomVal = mysqli_fetch_array($GotCustomFields))
		{
            ...
            if($TaxExempt == 0) {
                ...
                $data[] = array('<b>Product</b>' => '<b>' . $ThisLine . "</b>" . $ProductExtra, '<b>Price</b>' => 'R' . number_format($Price, 2), '<b>QTY</b>' => $Quantity, '<b>Sub Total</b>' => 'R' . number_format($LineSub, 2),
                    '<b>Discount</b>' => 'R' . number_format($LineDiscount, 2),'<b>Total</b>' => 'R' . number_format($LineTotal, 2));
			}
		}
        ...
        $data[] = array('<b>Total</b>'=>'<b>Discount</b>','<b>Price</b>'=>'R' . number_format($DiscountTotal,2));
        if($TaxExempt == 0) {
	...
	if ($NumSemiAnnually > 0)
	{
		...
		while ($CustomVal = mysqli_fetch_array($GotCustomFields))
		{
            ...
            if($TaxExempt == 0) {
                $data[] = array('<b>Product</b>' => '<b>' . $ThisLine . "</b>" . $ProductExtra, '<b>Price</b>' => 'R' . number_format($Price, 2), '<b>QTY</b>' => $Quantity,
					'<b>Sub Total</b>' => 'R' . number_format($LineSub, 2),
                    '<b>Discount</b>' => 'R' . number_format($LineDiscount, 2),
					'<b>VAT</b>' => 'R' . number_format($Vat, 2), '<b>Total</b>' => 'R' . number_format($LineTotal, 2));
            }else{
                $data[] = array('<b>Product</b>' => '<b>' . $ThisLine . "</b>" . $ProductExtra, '<b>Price</b>' => 'R' . number_format($Price, 2), '<b>QTY</b>' => $Quantity, '<b>Sub Total</b>' => 'R' . number_format($LineSub, 2),
	...
	if ($NumAnnually > 0)
	{
		...
		while ($Val = mysqli_fetch_array($GotLinesAnnually))
		{
            ...
            if($TaxExempt == 0) {
                $data[] = array('<b>Product</b>' => $ThisLine, '<b>Price</b>' => 'R' . number_format($Price, 2), '<b>QTY</b>' => $Quantity, '<b>Sub Total</b>' => 'R' . number_format($LineSub, 2),'<b>Discount</b>' => 'R' . number_format($LineSub, 2), '<b>VAT</b>' => 'R' . number_format($Vat, 2), '<b>Total</b>' => 'R' . number_format($LineTotal, 2));
            }else{
                $data[] = array('<b>Product</b>' => $ThisLine, '<b>Price</b>' => 'R' . number_format($Price, 2), '<b>QTY</b>' => $Quantity, '<b>Sub Total</b>' => 'R' . number_format($LineSub, 2),'<b>Discount</b>' => 'R' . number_format($LineSub, 2),  '<b>Total</b>' => 'R' . number_format($LineTotal, 2));
			}
		}
		...
		$data[] = array('<b>Total</b>'=>'<b>Sub Total</b>','<b>Price</b>'=>'R' . number_format($InvoiceSub,2));
        $data[] = array('<b>Total</b>'=>'<b>Discount</b>','<b>Price</b>'=>'R' . number_format($InvoiceSub,2));
        if($TaxExempt == 0) {
            $data[] = array('<b>Total</b>' => '<b>VAT</b>', '<b>Price</b>' => 'R' . number_format($InvoiceVat, 2));
        }
		$data[] = array('<b>Total</b>'=>'<b>Total</b>','<b>Price</b>'=>'<b>R' . number_format($InvoiceTotal,2) . '</b>');
