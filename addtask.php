...
function AddTask()
{
	...
	if (Task != '' && TaskDate != '')
	{
		var AddTask = agent.call('','AddNewTask','', Task, TaskDate, '<?php echo $CustomerID ?>');
		if (AddTask == "OK")
		{
			//LOG EVENT
			var Log = agent.call('','CreateClientAccess', '', <?php echo $CustomerID ?>, 'Added Customer Task');
					
			bootbox.alert('Task added successfully', function() {
                             ...
                             <div class="col-lg-12" style="padding-top: 10px">
                                        <h4 style="padding-bottom: 10px">Task Details</h4>
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <textarea class="form-control" placeholder="Task Description" id="task"></textarea>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control datepicker" id="datepicker" name="datepicker" placeholder="Task Date" value="" data-date-format="yyyy-mm-dd">
                                                ...
                                                <!-- END FORM CONTROLS -->
                                                 <div class="form-group row col-md-12" align="center" style="padding-top: 50px">
                                                	<button class="btn btn-info" onClick="javascript: AddTask();" style="">Add Task</button> 
