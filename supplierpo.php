...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$PurchaseOrders = GetSupplierPO($SupplierID);
            ...
            <div class="row">
                ...
                <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> Below you will find all purchase orders sent to the supplier. To add a new purchase order simply click on the Add Purchase Order button below
                            </div>
                 			<ul class="nav nav-tabs" style="margin-bottom: 20px">
								...
								<?php if ($Access == 1) { ?>    
                                    ...
                                    <div class="col-lg-12">
                                                 ...
                                                 <div class="col-lg-12">   
                                                 <h4>Purchase Orders <a href="editsupplierpo.php?s=<?php echo $SupplierID ?>" class="btn btn-default pull-right" style="margin-bottom: 10px" ><i class="fa fa-plus"></i> Add Purchase Order</a></h4>   
                                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        <?php while ($Val = mysqli_fetch_array($PurchaseOrders)) 
                                                        { 
                                                            ...
                                                            {
                                                                $ShowStatus = 'Sent to Supplier';
                                                            }
															else if ($PurchaseStatus == 2)
                                                            {
                                                                $ShowStatus = 'Converted to Invoice';
                                                            }
															
															$POTotal = GetPurchaseOrderTotal($PurchaseID);
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td><?php echo $PurchaseOrderDate ?></td>
                                                            <td><?php echo $AddedByName ?></td>
                                                            <td>R<?php echo number_format($POTotal, 2) ?></td>
                                                            <td><?php echo $ShowStatus ?></td>
                                                            
                                                           
                                                            <td class="center"><a href="editsupplierpo.php?s=<?php echo $SupplierID ?>&p=<?php echo $PurchaseID ?>" class="btn btn-sm btn-default">View PO Details</a></td>
