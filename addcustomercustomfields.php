...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	$ProductCustom = GetCustomerCustomFields();
...
function AddMainCustom()
{
	...
	var DisplayQuote = document.getElementById("displayquotes").value;
	
	if (FieldName != "" && Required != "" && DisplayOrder != "" && FieldType != "")
	{
		var DoUpdate = agent.call('','AddCustomCustomerField','', FieldName, Required, DisplayOrder, FieldType, DisplayInvoice, DisplayQuote);
		if (DoUpdate > 0)
		{
			...
			{
				document.location = 'editcustomercustomfields.php?c=' + DoUpdate;	
			}
		}
		else
		{
                ...
                <div class="col-lg-12">
					 ...
					 <ul class="nav nav-tabs" style="margin-bottom: 20px">
                            ...
                            <div class="form-group row col-md-6">
                              ...
                              <div class="col-sm-6">
                                <select class="form-control" id="displayquotes">
                                	<option value="1" >Yes</option>
                                    <option value="0" selected>No</option>
