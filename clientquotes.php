...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	CreateClientAccess($CustomerID, 'Accessed Customer Quotes');
	...
	if ($FoundClient != 0)
	{
		...
		$ClientInvoices = GetAllCustomerQuotes($CustomerID);
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to view all the customer generated quotes.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                             ...
                             <h4>Customer Quotes <a href="addcustomerquote.php?c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add Quote</a></h4>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        <?php while ($Val = mysqli_fetch_array($ClientInvoices))
                                                        {
															...
															{
																$Button = 	'<a href="editcustomerquote.php?q=' . $QuoteID . '&c=' . $CustomerID .'" class="btn btn-sm btn-default">Edit Quote</a>';
															}
															else
															{
																$Button = 	'<a href="showcustomerquote.php?q=' . $QuoteID . '&c=' . $CustomerID .'" class="btn btn-sm btn-default">Show Quote</a>';
															}
