...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	CreateClientAccess($CustomerID, 'Accessed Customer Follow Ups');
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to add any follow ups for your client. To add a new follow up simply click on the Add Follow Up button below.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <!-- /.panel-heading -->
                            ...
                            <!-- Tab panes -->
                                    ...
                                    <div class="col-lg-12" style="padding-top: 10px">
                                     ...
                                     <h4>Customer Follow Ups <a href="addfollowup.php?c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> Add Follow Up</a></h4>
                                                ...
                                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td><a href="editfollowup.php?f=<?php echo $FollowUpID ?>&c=<?php echo $CustomerID ?>" class="btn btn-sm btn-default">View Details</a></td>
