...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	if ($FoundClient != 0)
	{
		...
		$CustomerLogs = GetCustomerLogs($CustomerID);
		$EmailLogs = GetCustomerEmailLogs($CustomerID);
		...
		if ($_SESSION["MainClient"] == 1)
	{
		...
		{
			$Access = CheckPageAccess('Access Logs');	
		}
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-info">
                             <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                              <strong><i class="fa fa-info-circle fa-fw" style="font-size: 16px"></i></strong> This page allows you to view all the customer access logs recorded on the system.
                            </div>     
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="clientlogs.php?c=<?php echo $CustomerID ?>">Logs</a>
                                </li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example2" style="font-size: 12px">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                	<?php while ($Val = mysqli_fetch_array($EmailLogs)) 
									{ 
										$LogDate = $Val["LogAdded"];
										$LogType = $Val["LogType"] . " - " . $Val["LogText"];
                            ...
                            <!-- /.table-responsive -->
                             ...
                             <div class="col-lg-12" style="padding-top: 30px; padding-bottom: 50px"> 
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size: 12px">
                                ...
                                <tbody>
                                	<?php while ($Val = mysqli_fetch_array($CustomerLogs)) 
									{ 
										$LogDate = $Val["LogDate"];
										$LogType = $Val["LogType"];
