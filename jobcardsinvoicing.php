...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	{
		$Access = CheckPageAccess('Jobcards Waiting Invoicing');	
	}
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 20px">
                                ...
                                <li  class="active"><a href="jobcardsinvoicing.php"><i class="fa fa-caret-right"></i> Job Cards Waiting Invoicing</a>
                                </li>
