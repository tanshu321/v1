...
if ($ThisClientID > 0 && $ThisUser != "" && $ThisSecret == "E2A_crm_S5gdbh6nnj_usr_9898")
{
	...
	if ($FoundClient != 0)
	{
		...
		$SiteDetails = GetSiteDetails($CustomerID, $SiteID);
		
		while ($Val = mysqli_fetch_array($SiteDetails))
		{
...
<body>
                                    ...
                                    <div class="col-lg-12">
                                        <h4 style="padding-bottom: 10px">Site Details</h4>
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="sitename" placeholder="Site Name" value="<?php echo $SiteName ?>">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="contactperson" placeholder="Contact Person" value="<?php echo $ContactPerson ?>">
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-6">
                                                  ...
                                                  <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="emailaddress" placeholder="Email Address" value="<?php echo $SiteEmail ?>">
                                                  </div>
                                                </div>
	...
	function UpdateClient()
	{
		...
		if (Error != 1)
		{
				...
				var DoUpdateClient = agent.call('','UpdateSiteDetails','', SiteName, ContactName, ContactTel, EmailAddress, Address1, Address2, City, State, PostCode, Country, '<?php echo $CustomerID ?>', '<?php echo $SiteID ?>');
				if (DoUpdateClient == "OK")
				{
					//LOG EVENT
					var Log = agent.call('','CreateClientAccess', '', <?php echo $CustomerID ?>, 'Updated Client Site - <?php echo $SiteName ?>');
